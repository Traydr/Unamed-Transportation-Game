...
public class FileHandler : MonoBehaviour
{
    ...
    private void SaveGame() 
    {
        ...
        int tempMoney = gameHandler.GetComponent<GameMoneyHandler>().ReadMoney();
        int tempTotalTime = gameHandler.GetComponent<GameTimeHandler>().GetTimeInHours();
    ...
    private void LoadGame() 
    {
        ...
        gameHandler.GetComponent<GameMoneyHandler>().WriteMoney(int.Parse(saveData[0]));
        gameHandler.GetComponent<GameTimeHandler>().SetTimeFromTotalHours(int.Parse(saveData[1]));
    }
